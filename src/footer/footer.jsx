...
const Footer = () => {
  return (
    <footer className="w-full h-32 flex flex-col items-center px-5 gap-y-5 md:flex-row md:justify-between absolute border-t-2 bottom-0 bg-white dark:bg-gray-800 dark:text-white">
