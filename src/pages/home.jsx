...
const Home = () => {
  return (
    <section className="night px-5 pt-20 max-w-3xl xl:max-w-5xl m-auto h-fit pb-52 xl:w-3/4">
      <div className="w-64 h-64 flex justify-center items-center overflow-hidden m-auto rounded-full mb-5">
        <img
          src="fotoku.jpg"
          alt=""
          className="w-64 h-64 rounded-full object-cover object-bottom mb-5 scale-150 -translate-y-10 md:mb-7 md:w-72 md:h-72"
        />
      </div>
